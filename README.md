...
Or if no song is passed through, it will default to *"Don't Stop Believin'" by Journey
...
Rotten Tomatoes URL.
Or if no movie is passed through, it will default to "Little Miss Sunshine"
